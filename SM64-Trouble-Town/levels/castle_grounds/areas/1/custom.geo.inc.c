...
const GeoLayout Geo_castle_grounds_1_0x14ac080[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_castle_grounds_1_0xe039910),
					GEO_DISPLAY_LIST(5, DL_castle_grounds_1_0xe043198),
					GEO_DISPLAY_LIST(4, DL_castle_grounds_1_0xe043450),
					GEO_RENDER_OBJ(),
